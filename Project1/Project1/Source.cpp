...
int main()
{
	...
	if (num == 1) {
		...
		printf("Your square area is %.3f", area1);
	}
	else if (num == 2) {
		printf("\n2 : Rectangle \n\n");
		...
		area2 = num21 * num22;
		printf("\narea = length * width \n\n");
		printf("The area of your rectangle is %.3f", area2);
	}
	else if (num == 3) {
		printf("\n3 : Triangle \n\n");
		...
		printf("The area of your triangle is %.3f", area3);
	}
	else if (num == 4) {
		printf("\n4 : Rhombus \n\n");
		...
		printf("The area of your Rhombus is %.3f", area4);
	}
	else if (num == 5) {
		printf("\n5 : Parallelogram \n\n");
		printf("Please enter the base length : ");
		...
		printf("The area of your Parallelogram is %.3f", area5);
	}
	else if (num == 6) {
		printf("\n6 : Kite \n\n");
		printf("Please enter the length of the diagonal : ");
		...
		printf("\narea = 1/2 * (length of the diagonal * length of the diagonal) \n\n");
		printf("The area of your kite is %.3f", area6);
	}
	else if (num == 7) {
		printf("\n7 : Trapezoid \n\n");
		...
		printf("The area of your trapezoid is %.3f", area7);
	}
	else if (num == 8) {
		printf("\n8 : Circle \n\n");
